				...
				<div class="tabs-content">
					...
					<div class="tab-content" id="tab-detail">
						<div class="left">
							<table>
								<tbody>
									<?php foreach ( (array) ( $custom_data['custom_field'] ?? [] ) as $k => $v ) : ?>
										<tr>
											<td><b><?php echo esc_html( $v['label'] ); ?>:</b></td>
											<td class="attribute-<?= esc_attr( $k ) ?>"><?php echo esc_html( is_array($v['value']) ? implode(', ', $v['value']) : $v['value'] ); ?></td>
										</tr>
									<?php endforeach; ?>
									<?php
									$detail_table_taxonomies = [ 'chat-lieu', 'bo-suu-tap' ];
